...
Файлы настроек:  
    - [Vagrantfile](./Old_practice/Раздел_5/Practice_5.2/Vagrantfile)  
    - [playbook.yml](./Old_practice/Раздел_5/Practice_5.2/playbook.yml)  
    - [ansible.cfg](./Old_practice/Раздел_5/Practice_5.2/ansible.cfg)  
    - [./inventory/hosts](./Old_practice/Раздел_5/Practice_5.2/inventory/hosts)  
